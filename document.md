...
2. [Document Object](#doc)
    1. [Text Methods](#text)
    2. [Page Methods](#page)
    3. [Font Methods](#font)
    4. [Color Methods](#color)
    5. [Cursor Methods](#cursor)
    6. [Shape Methods](#shape)
    7. [Image Methods](#image)
    8. [Table Methods](#table)
3. [Cursor Object](cursor.html)
4. [Color Object](color.html)
5. [Tables](tables.html)
6. [Cell Formats](cellformat.html)

# <a name='doc'></a>Document Object
...
### document.start_block_indent(int)
...
### document.add_page_numbers(location, font, cursor, color, text1="Page %s", text2=None)
...
* If you want to change the colors, there are two ways to do it.
    * Get a default black and change it
...
### document.set_text_color(color)

* Color must be a PDFColor object.
* Default is black.

### document.set_draw_color(color)

* Color must be a PDFColor object.
* Default is black.

### document.set_fill_color(color)
...
### document.set_background_image(image)
...
* **data (dictionary):**
    ...
    See [Cell Formats](cellformat.html) for possible data values, and defaults.
